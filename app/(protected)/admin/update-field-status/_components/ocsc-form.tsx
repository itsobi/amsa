...
export function OCSCForm({ field }: { field: Doc<'fields'> | undefined }) {
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FieldSet className="mt-4">
          <FieldLegend>Onion Creek Soccer Complex</FieldLegend>
          <FieldDescription>Update the field status of OCSC.</FieldDescription>
          <FieldGroup>
            <Controller
              name="status"
