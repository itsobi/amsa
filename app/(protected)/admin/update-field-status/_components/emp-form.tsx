...
export function EMPForm({ field }: { field: Doc<'fields'> | undefined }) {
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FieldSet className="mt-4">
          <FieldLegend>East Metropolitan Park</FieldLegend>
          <FieldDescription>Update the field status of EMP.</FieldDescription>
          <FieldGroup>
            <Controller
              name="status"
