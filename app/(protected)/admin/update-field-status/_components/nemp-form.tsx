...
export function NEMPForm({ field }: { field: Doc<'fields'> | undefined }) {
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FieldSet className="mt-4">
          <FieldLegend>North East Metropolitan Field</FieldLegend>
          <FieldDescription>Update the field status of NEMP.</FieldDescription>
          <FieldGroup>
            <Controller
              name="status"
